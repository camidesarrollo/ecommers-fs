...
.bg-pattern {
  ...
  background-image: radial-gradient(circle at 25px 25px, rgba(139, 119, 101, 0.05) 2%, transparent 0%),
    radial-gradient(circle at 75px 75px, rgba(139, 119, 101, 0.05) 2%, transparent 0%);
...
@keyframes pulseWarm {
  0%,
  100% {
    box-shadow: 0 0 0 0 rgba(139, 119, 101, 0.7);
  }
  50% {
    box-shadow: 0 0 0 10px rgba(139, 119, 101, 0);
  }
}

.bg-gradient-nuts {
  background: linear-gradient(135deg, #8b7765 0%, #6b5d4f 100%);
}
...
.btn-primary:hover:not(:disabled) {
  ...
  box-shadow: 0 4px 12px rgba(139, 119, 101, 0.4);
}
